...
- Evidence scan status UI component (#593): `EvidenceScanStatus` shows pending, clean, infected, error and skipped scan states with state-specific copy, links only to clean files, and treats unknown statuses as pending. Wiring it into the evidence pages and withholding file URLs server-side are not in this change
